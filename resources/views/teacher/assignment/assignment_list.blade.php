    ...
    <div class='col-12 '>
        <table class='col-12'>
            <tr style='border-top:5px solid #3f3b3b'>
                ...
                <td class='bg-dark mt-1' style='padding:5px 20px'>Due Date</td>
                <td class='bg-dark mt-1' style='border-radius:0px 5px 5px 0px;padding:5px 20px'>Operation</td>
            </tr>
            @foreach ($assignments as $assignment)
        <tr style='border-top:5px solid #3f3b3b'>
            <td class='bg-dark mt-1' style='border-radius:5px 0px 0px 5px;padding:5px 20px'>{{$assignment->assignment_name}} </td>
            <td class='bg-dark mt-1' style='padding:5px 20px'>{{$assignment->created_at}}</td>
            <td class='bg-dark mt-1' style='padding:5px 20px'><a href="{{route('assignment#view',$assignment->id)}}">View</a></td>
            <td class='bg-dark mt-1' style='padding:5px 20px'>{{$assignment->due_date}}</td>
            <td class='bg-dark mt-1' style='border-radius:0px 5px 5px 0px;padding:5px 20px'><a class='text-danger offset-3' href='{{route('delete#assignment',$assignment->id)}}'>Delete</a></td>
        </tr>
        @endforeach
        </table>
